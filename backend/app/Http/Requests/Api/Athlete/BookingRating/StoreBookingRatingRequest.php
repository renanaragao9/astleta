...
class StoreBookingRatingRequest extends BaseFormRequest
{
    public function rules(): array
    {
        return [
            ...
            'mental_rating' => 'required|integer|min:1|max:10',
            'teamwork_rating' => 'required|integer|min:1|max:10',
    ...
    public function messages(): array
    {
        return [
            ...
            'rating.required' => 'Avaliação geral é obrigatória.',
            ...
            'technical_rating.required' => 'Avaliação técnica é obrigatória.',
            ...
            'tactical_rating.required' => 'Avaliação tática é obrigatória.',
            ...
            'physical_rating.required' => 'Avaliação física é obrigatória.',
            ...
            'mental_rating.required' => 'Avaliação mental é obrigatória.',
            ...
            'teamwork_rating.required' => 'Avaliação de trabalho em equipe é obrigatória.',
