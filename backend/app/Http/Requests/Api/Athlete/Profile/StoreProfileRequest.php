...
class StoreProfileRequest extends BaseFormRequest
{
    ...
    {
        return [
            'dominant_side' => 'required|string|in:esquerdo,direito,ambos',
    ...
    {
        return [
            'dominant_side.required' => 'O lado dominante é obrigatório.',
            ...
            'feature_id.required' => 'A característica é obrigatória.',
